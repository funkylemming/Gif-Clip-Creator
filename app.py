    ...
    if not video_url.strip():
        ...
        with st.spinner("Processing clip... please wait (GIFs take ~15-30s on cloud servers)."):
            ...
            if os.path.exists(out) and os.path.getsize(out) > 0:
                ...
                st.error("Processing failed. Please verify the URL or timestamps.")user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36'
